...
-- depends_on: {{ ref('airbyte_lesson_history_lesson_history_tags_ab1') }}
select
    ...
    cast(lesson_history_tag_id as {{ dbt_utils.type_string() }}) as lesson_history_tag_id,
    _airbyte_ab_id,
    _airbyte_emitted_at,
    {{ current_timestamp() }} as _airbyte_normalized_at
from {{ ref('airbyte_lesson_history_lesson_history_tags_ab1') }}
