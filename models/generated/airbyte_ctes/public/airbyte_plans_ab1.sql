...
-- depends_on: {{ source('public', '_airbyte_raw_airbyte_plans') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['hotmart_id'], ['hotmart_id']) }} as hotmart_id,
    {{ json_extract_scalar('_airbyte_data', ['updated_at'], ['updated_at']) }} as updated_at,
    {{ json_extract_scalar('_airbyte_data', ['duration_in_months'], ['duration_in_months']) }} as duration_in_months,
    _airbyte_ab_id,
    _airbyte_emitted_at,
    {{ current_timestamp() }} as _airbyte_normalized_at
from {{ source('public', '_airbyte_raw_airbyte_plans') }} as table_alias
-- airbyte_plans
where 1 = 1
