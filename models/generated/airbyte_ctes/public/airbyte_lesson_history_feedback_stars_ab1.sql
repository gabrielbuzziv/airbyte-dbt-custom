...
-- depends_on: {{ source('public', '_airbyte_raw_airbyte_lesson_history_feedback_stars') }}
select
...
from {{ source('public', '_airbyte_raw_airbyte_lesson_history_feedback_stars') }} as table_alias
