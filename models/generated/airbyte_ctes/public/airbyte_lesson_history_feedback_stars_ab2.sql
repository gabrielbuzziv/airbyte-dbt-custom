...
-- depends_on: {{ ref('airbyte_lesson_history_feedback_stars_ab1') }}
select
    cast({{ adapter.quote('id') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('id') }},
    cast({{ adapter.quote('time') }} as {{ dbt_utils.type_bigint() }}) as {{ adapter.quote('time') }},
    cast(stars as {{ dbt_utils.type_bigint() }}) as stars,
...
from {{ ref('airbyte_lesson_history_feedback_stars_ab1') }}
